        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    Rejected  Investment Applications List
                    </h4>
                ...
                <div class="card-body mt-1 table-wrapper">
                    <div class="table-responsive">
                        ...
                        $total_interest = 0;
                            ...
                            $total_interest = $val->total*$val->tenure;
                           ?>
                                ...
                                <td class="align-middle">
                                        <div class="action">
                                           ...
                                           <a href="#" id="invest-reject" invest-delete-id="{{$val->investment_id}}" class="btn btn-danger" ><i class="la la-trash"></i></a>
                                        </div>
                                    </td>  
