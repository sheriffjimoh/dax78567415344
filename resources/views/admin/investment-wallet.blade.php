                ...
                <div class="card-header">
                    ...
                    <div class="text-center">
                        ...
                        @foreach($wallets as $data )
                         ...
                         @endforeach
                         @if(isset($data))
                        <h3 ><strong>Total amount Available: <span class="text-primary">{{'₦'. number_format($data->available_balance,2)  }}</span></strong></h3>
                         @endif
                      @endif
                    </div>
                        ...
                        <table  class="table table-striped table-bordered zero-configuration">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-top-0" >Investor's name</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{$srn}}</td>
                                  ...
                                  <td>
                                      <?php 
                                  echo  MainController::Fullname($data->investor_id);
                                     ?> 
                                  </td>
                          ...
                          <span class="dropdown">
                                ...
                                <span aria-labelledby="btnSearchDrop28" class="dropdown-menu mt-1 dropdown-menu-right">
                                       ...
                                       <a href="/deletewallet/{{$data->id}}" class="dropdown-item" onclick="return confirm('are you sure you want to delete? ')" >
