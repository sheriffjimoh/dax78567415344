          ...
          @endif
                ...
                <div class="card-header">
                    <h4 class="card-title float-left">
                       Overdue  Repayment( From <?php  echo date('Y-m-d', strtotime('-15 day')) ?>  To <?php echo date('Y-m-d') ?>)
                    </h4>
                        ...
                        <table id="example1" class="table alt-pagination loan-wrapper">
                           ...
                           ?>
                                <tr>
                                 ...
                                 <td><?php echo  $value['repayment_date']?> 

                                 <span class="badge badge-success"><?php
                               if ($value['repayment_date']== $date) {
                                echo "today";
                               }else{
                                  echo LoanController::getTimeAgo($value['repayment_date']);} ?></span>
                                 ...
                                 <td><a href="/repay_single_overdue/{{ $value['loan_id']}}" id="btn-paid" class="btn btn-primary">Mark</a></td>
                                </tr>
                                    
                            <?php }  ?>
                             <td > 
                              <?php if (count($data) > 0) {?>
                             <a href="/markall_overdue" class="btn btn-primary">Mark&nbsp;&nbsp;all</a>
                               <?php } ?>
                             </td>
                              <td></td>
                               <td></td>
