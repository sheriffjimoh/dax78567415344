...
@section('content')
  ...
  <div class="card  " >
    ...
    <h3 class="card-title">Investment Portfolio(Currents)</h3>
              ...
              <hr>
               ...
               <div class="collapse" id="col<?php echo $val->investment_id ?>">
                  <div class="card card-body port-d"> 
                   ...
                   <li>Total Interest <i class="la la-arrow-right"></i> ₦ {{number_format(ceil($total_interest),2)}} </li>
                    <li>Total<i class="la la-arrow-right"></i> ₦ {{number_format(ceil($val->amount+$total_interest),2)}} </li>
