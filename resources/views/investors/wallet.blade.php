            ...
            <div class="col-lg-4 col-md-12 col-sm-12 offset-md-4 border-right-lighten-5">
              <div class="card-body text-center">
                <div class="card-header mb-2">
                  ...
                  <h3 class="display-4 blue-grey darken-1">{{isset($wallet)? number_format($wallet,2)  :0}}</h3>
                </div>
                <div class="card-content"><!-- 
                  <input type="text" value="35" class="knob hide-value responsive angle-offset" data-angleOffset="40"
                    data-thickness=".15" data-linecap="round" data-width="150" data-height="150"
                    data-inputColor="#e1e1e1" data-readOnly="true" data-fgColor="#28D094" data-knob-icon="icon-note"> -->
                  <ul class="list-inline clearfix mt-2">
                    <li class="border-right-lighten-2 pr-1">
                        ...
                        <form action="/withdraw"  enctype="multipart/form-data" method="Post" class="icons-tab-steps wizard-circle " autocomplete="off">
                            ...
                            <fieldset>
                                <div class="row">
                                   ...
                                   <input type="hidden" name="balance" id="w_balance" value="{{isset($wallet)? $wallet :0}}">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                         
                                          <label class="text-info">  <i class="step-icon la la-info"></i> &nbsp;The available balance is : ₦ {{isset($wallet)? number_format($wallet,2) :0}}</label>
                                           <p></p>
                                        </div>
                                    </div>
