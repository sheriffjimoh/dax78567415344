...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px;" align="center">
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Hello , {{$details['user_name']}}!&nbsp;</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div>
          ...
          <div style="font-family: inherit; text-align: left;"><span style="font-size: 18px">This Tomi From Daxlinks, i hope that this message find you, we are happy to inform you that your Loan request has been granted after a thoroughly review ,Look at the loan  details below, if you need to learn about our repayment method  see <a href="http://tomxcredit.com/">here</a></span>
          <br>
            <br>
            <ul style=" list-style: none; text-align: left;">
              <li style="margin-bottom: 5px;"> <span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif">Loan Amount: &nbsp;₦{{number_format($details['loan_amount'],2)}}.</span></li>

              <li style="margin-bottom: 5px;"><span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif">Loan Tenure: &nbsp;{{$details['loan_tenure']}}</span></li>
               <li style="margin-bottom: 5px;"><span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif">Repayment Amount: &nbsp;₦{{number_format($details['repayment_amount'],2)}}</span></li>
                <li style="margin-bottom: 5px;"><span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif">Repayment Date: &nbsp;{{$details['repayment_date']}}</span></li>
            </ul>
...
<div style="font-family: inherit; text-align: left"><span style="color: #ffffff; font-size: 18px">ready to help!&nbsp;</span></div><div>
