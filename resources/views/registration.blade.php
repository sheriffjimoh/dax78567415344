...
<head>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="{{ asset ('reg-assets/img/favicon.png')}}">
...
<body>
    ...
    <nav class="navbar navbar-light ">
      <span class="navbar-brand mb-0 h1">
        <a href=""> <img src="{{ asset ('reg-assets/img/logo2.png')}}"></a></span>
    </nav>
             ...
             <div class="progress-bar">
              <span></span>
               ...
               <div class="container-fluid">
                <form class="form-horizontal" action="{{ route('registrations.store') }}" enctype=" multipart/form-data">
                  <input id="signup-token" name="token" type="hidden" value="{{csrf_token()}}">
                  <div class="err">
                  <div class="col-lg-6 offset-lg-2" id="error_alert">
                    <div class="alert alert-warning alert-dn alert-dismissible " role="alert" >
                   ...
                   <div class="succ">
                  <div class="col-lg-6 offset-lg-2" id="success_alert">
                    <div class="alert alert-success alert-succ alert-dismissible " role="alert" >
                   ...
                   <div class="nestedrow my-inputs" id="bvn">
                    ...
                    <div class="row">
                     ...
                     <div  class="col-lg-8 " id="bvnbox">
                      ...
                      <div class="col-lg-12 col-12 checkbox">
                             <p>I have read, understood and accept all the terms and<br> conditions & privacy policy for Page International Financial Services Limited.</p>                       </div>
                       ...
                       <div  class="col-lg-4">
                         <div class="input-group mb-2 input-n dependent-err-line">
                           ...
                           <select aria-label="dependent" aria-describedby="basic-addon1" class="form-control" 
                            id="dependent">
                                <option selected=" " value="" disabled>No of Dependents</option>
                     ...
                     <!-- <h3 class="lead"><span class="color-b-line"> Personal </span> Details</h3> -->
                       ...
                       <div  class="col-lg-4">
                         <div class="input-group mb-2  input-n  state-err-line">
                          ...
                          <select aria-label="marital" aria-describedby="basic-addon1" class="form-control " id="state">
                            <option selected="" value="" disabled>Select  State of resident</option>
                     ...
                     <!-- <h3 class="lead"><span class="color-b-line"> Personal </span> Details</h3> -->
                       ...
                       <div  class="col-lg-4">
                         <div class="input-group mb-2  input-n  local-err-line ">
                          ...
                          <select aria-label="local" aria-describedby="basic-addon1" class="form-control" id="local">
                            <option selected disabled>Select  Local Gov Area</option>
                    ...
                    <div class="row">
                     ...
                     <div  class="col-lg-4">
                        ...
                        <div class="input-group mb-2 input-n loanamount-err-line">
                          ...
                          <input type="number" class="form-control" placeholder="Loan Amount" aria-label="bvn" aria-describedby="basic-addon1" id="loanamount">
                        </div>
                         <div class="error-msg">
